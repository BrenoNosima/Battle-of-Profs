<!--
  phaser-vue-final.vue
  
  Jogo completo com:
  - Sprites para jogador e inimigo
  - Física e colisões
      ...
      class FightScene extends Phaser.Scene {
        ...
        preload() {
          ...
          try {
            ...
            console.log('Sons não encontrados');
          }
        }
        ...
        create() {
          ...
          this.sounds = {
            ...
            victory: this.sound.add('victory', { volume: 0.7 }),
            defeat: this.sound.add('defeat', { volume: 0.7 })
          };
        ...
        playerAttack() {
          ...
          if (distance < attackRange) {
            ...
            // Reproduzir animação de dano no inimigo
            this.enemy.play('enemy-hurt', true);
          ...
          // Terminar ataque após a animação
        ...
        enemyAttack() {
          ...
          if (distance < attackRange) {
            ...
            // Reproduzir animação de dano no jogador
          ...
          // Terminar ataque após a animação
          this.enemy.on('animationcomplete-enemy-attack', () => {
            // Voltar para animação idle
        ...
        checkRoundEnd() {
          ...
          if (this.player.health <= 0 || this.enemy.health <= 0) {
            ...
            if (this.player.health <= 0 && this.enemy.health <= 0) {
              ...
              if (this.sounds && this.sounds.defeat) {
