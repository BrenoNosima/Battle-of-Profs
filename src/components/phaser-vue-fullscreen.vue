<!--
  phaser-vue-fullscreen.vue
  
  Versão fullscreen do jogo sem estatísticas:
  - Canvas em tela cheia
  - Sem painel de estatísticas
  - Mantém todas as funcionalidades do jogo
-->
